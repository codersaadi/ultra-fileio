...
<Callout type="info">
  Want a better UI? Check out our [Client-Side Upload](/docs/client-side-upload) guide for a pre-built Dropzone component.
</Callout>
...
<Cards>
  ...
  <Card title="Client Components" href="/docs/client-side-upload">
