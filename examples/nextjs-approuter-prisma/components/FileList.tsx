...
import { Trash2, File as FileIcon, ExternalLink } from 'lucide-react'
                                ...
                                <div className="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                                    <div>
                                        ...
                                        <p className="mt-2 flex items-center text-sm text-gray-500 dark:text-gray-400">
                                            <span className="truncate">{(file.fileSize / 1024).toFixed(1)} KB</span>
                                        </p>
                                    </div>
                                    <div className="hidden md:block">
                                        <div>
                                            <p className="text-sm text-gray-900 dark:text-white">
                                                Uploaded on <time dateTime={file.createdAt}>{new Date(file.createdAt).toLocaleDateString()}</time>
                                            </p>
                                        </div>
                                    </div>
                                </div>
